...
const navigation = [
  ...
  { name: 'Bolliwood', href: '/bolliwood/bolliwood', current: false },
  { name: 'Holliwood', href: '/holliwood/holliwood', current: false },
  { name: 'South', href: '/south/south', current: false },
]
...
export default function Navbar() {
  ...
  return (
    <Disclosure as="nav" className="bg-gray-800">
      {({ open }) => (
        <>
          <div className="mx-auto max-w-7xl px-0 sm:px-3 lg:px-3">
