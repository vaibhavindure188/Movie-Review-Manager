...
import Mens_kurta from '../homeSectionCorousel/Data.js'
import FilterListIcon from '@mui/icons-material/FilterList';
import {useLocation,  useNavigate,  useNavigation} from 'react-router-dom'
import HolliwoodData from '../../../assets/moveData/HolliwoodMovieData.js'
const sortOptions = [
...
export default function HolliwoodMovie() {
      ...
      <div>
        ...
        <main className="mx-auto  px-4 sm:px-6 lg:px-20">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">The Best Movies</h1>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              ...
              <div className="lg:col-span-4 w-full">
                <div className='flex flex-wrap justify-center bg-white py-5'>
                    {
                        HolliwoodData.map((item) => <ProductCard product = {item} />)
                }
                </div>
